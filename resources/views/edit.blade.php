        ...
        <div class="card-body">
            <form action="/update/{{ $project->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                    @enderror" name="name" value="{{ $project->name }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                    @enderror" name="client" value="{{$project->client}}"> @error('client')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                     @enderror" name="leader" value="{{$project->leader }}"> @error('leader')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                @enderror" name="email" value="{{ $project->email }}">
                    @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                @enderror" name="start_date" value="{{ $project->start_date }}"> @error('start_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                @enderror" name="end_date" value="{{ $project->end_date }}"> @error('end_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
                            ...
                            <div class="col-md-8">
                                <div class="progress">
                                    <div class="progress-bar" data-length="30" role="progressbar" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {{ $project->name }}%"></div>
                                </div>
